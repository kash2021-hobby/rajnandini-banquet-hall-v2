      ...
      <div className="container grid lg:grid-cols-2 gap-12 lg:gap-20 items-center bg-[#f3f4ec]">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div
              className="w-[320px] h-[380px] lg:w-[400px] lg:h-[480px] overflow-hidden"
              style={{
                borderRadius: "60% 40% 30% 70% / 60% 30% 70% 40%",
                border: "3px solid hsl(36, 32%, 58%)",
              }}
            >
              <img src="hero-1.webp" alt="Rajnandini Banquet Hall exterior" className="w-full h-full object-cover" />
            </div>
            {/* Decorative dots */}
        ...
        <div className="space-y-6">
          <p className="text-primary font-body text-sm font-medium uppercase tracking-widest">About Us</p>
          ...
          <p className="font-body text-muted-foreground text-base leading-relaxed">
            Located in the heart of the city and easily accessible from Beltola, Dispur, and Six Mile, Rajnandini offers
            a spacious and fully equipped setting for your most cherished days.
          </p>
          <p className="font-body text-muted-foreground text-base leading-relaxed">
            From intimate gatherings to grand wedding receptions, our experienced team ensures every event is executed
            with precision and elegance. With state-of-the-art amenities and personalized service, we create
